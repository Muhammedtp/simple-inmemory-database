...
//     // INSERT - All data types with different value formats
...
//     // SELECT - All data types in WHERE clauses
...
//     "create table test_case (id INT, name STRING)",
//     "INSERT into test_case VALUES (1, 'Test')",
//     "select * from test_case",
//     "update test_case set name = 'Updated' where id = 1",
//     "delete from test_case where name = 'Updated'",
